...
# setting up the page to accomodate four graph in two rows and two columns

par(mfrow = c(2,2))

#subgraph 1
plot(powr_final$Date_Time,powr_final$Global_active_power,type = "l",xlab ="",ylab = "Global Active Power (kilowatts)")

#subgraph 2
plot(powr_final$Date_Time,powr_final$Voltage,type = "l",xlab ="",ylab = "Voltage")
...
#subgraph 4 
plot(powr_final$Date_Time,powr_final$Global_reactive_power,type = "l",xlab ="",ylab = "Global_reactive_power")
